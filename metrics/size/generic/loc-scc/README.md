...
Module-level LOC using scc (code lines only).

## Build

```bash
docker build -t loc-scc:latest metrics/size/generic/loc-scc
```
...
`/results/software-metrics/jsonl/<project>-<timestamp>-loc-scc-default.jsonl`
