...
def test_build_manifest_ignores_runtime_telemetry_jsonl(tmp_path: Path):
    module = load_module(MODULE_PATH, "analysis_build_manifest_ignore_runtime")
    run_id = "11111111-1111-4111-8111-111111111111"
    results_dir = tmp_path / "results"
    results_dir.mkdir(parents=True, exist_ok=True)
    (results_dir / "sample.jsonl").write_text(
    ...
    (results_dir / "metric-runtime-11111111-1111-4111-8111-111111111111.jsonl").write_text(
        '{"run_id":"11111111-1111-4111-8111-111111111111","metric_container":"loc-cloc:latest","duration_seconds":1.0}\n',
        encoding="utf-8",
    )

    manifest = module.build_manifest(results_dir=results_dir, run_id=run_id)
